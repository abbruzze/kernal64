...
object Preferences {
  ...
  val PREF_VICPALETTE_FILE    = "vic-palette-file"
  ...
  val PREF_RAMCART            = "ram-cart"
  val PREF_ISEPIC             = "isepic-enabled"
  ...
  val PREF_VDCPALETTEFILE     = "vdc-palette-file"
  val PREF_128EXTROM          = "ext-rom"
  val PREF_128INTROM          = "int-rom"
  val PREF_128FULLRAM         = "256k"
