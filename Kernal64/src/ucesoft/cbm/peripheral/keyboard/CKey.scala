...
object CKey extends Enumeration {
	  ...
	  val RESTORE: CKey.Value = Value(0xFF)
		...
		val CBM2_KP_QMARK : CKey.Value = Value(0x21C)
		val CBM2_KP_CE: CKey.Value = Value(0x21D)
		val CBM2_KP_MUL : CKey.Value = Value(0x21E)
		val CBM2_KP_DIV : CKey.Value = Value(0x21F)
		// C
		...
		val CBM2_MINUS : CKey.Value = Value(0x229)
		...
		val CBM2_KP_MINUS : CKey.Value = Value(0x22F)
		// D
		...
		val CBM2_CLOSED_SBRACKET: CKey.Value = Value(0x23A)
		...
		val CBM2_KP_PLUS : CKey.Value = Value(0x23F)
		// E
		...
		val CBM2_OPEN_SBRACKET: CKey.Value = Value(0x249)
		...
		val CBM2_SLASH : CKey.Value = Value(0x258)
